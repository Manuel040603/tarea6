 ...
 */
// ---------- 5. SportsApp recibe windowSize (WindowWidthSizeClass) y onBackPressed ----------
@Composable
fun SportsApp(
    ...
    // ---------- 8. contentType a partir de widthSizeClass (when como expresión) ----------
    ...
    Scaffold(
        ...
        // ---------- 9. Mostrar SportsListAndDetail si ListAndDetail; si es ListOnly, el comportamiento anterior ----------
...
fun SportsAppBar(
    ...
    // ---------- 10. SportsAppBar: en pantalla expandida no hay botón atrás y el título es 'Sports' ----------
...
// ---------- 1. Elemento componible de pantalla expandida: SportsListAndDetail (lista + detalle en un Row) ----------
@Composable
private fun SportsListAndDetail(
    ...
    Row(
        ...
        SportsDetail(
            ...
            // ---------- 3. Botón atrás: se pasa la lambda onBackPressed a SportsDetail ----------
            onBackPressed = onBackPressed,
        )
    }
}
...
// ---------- 2. Vista previa de SportsListAndDetail en tablet ----------
