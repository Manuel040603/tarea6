...
// ---------- 8. ReplyHomeScreen recibe navigationType como parámetro ----------
@Composable
fun ReplyHomeScreen(
    ...
    // ---------- 9. Panel lateral permanente (PermanentNavigationDrawer) para pantallas expandidas ----------
    if (navigationType == ReplyNavigationType.PERMANENT_NAVIGATION_DRAWER && replyUiState.isShowingHomepage) {
        ...
        // ---------- 1. Cambiar de pantalla con estado: if/else sobre isShowingHomepage (sin NavHost) ----------
...
private fun ReplyAppContent(
    ...
    Box(modifier = modifier) {
        Row(modifier = Modifier.fillMaxSize()) {
            // ---------- 10. Riel de navegación (NavigationRail) solo si navigationType == NAVIGATION_RAIL ----------
            ...
            Column(
                ...
                // ---------- 11. Barra de navegación inferior solo si navigationType == BOTTOM_NAVIGATION ----------
                AnimatedVisibility(
